...
export default function Candlestick({ symbol }) {
  ...
  return (
    <div className="candlestick__container">
      ...
      <div className="candlestick__button">
        <button className="candlestick__button--item">1D</button>
        <button className="candlestick__button--item">14D</button>
        <button className="candlestick__button--item">1M</button>
      </div>
    </div>
  );
}
